...
// 	if (date1 > date2) {
// 		return new Date(randomValueBetween(date2, date1)).toLocaleDateString('default', {
// 			year: 'numeric',
// 			month: 'long',
// 			day: 'numeric',
// 		});
// 	} else {
// 		return new Date(randomValueBetween(date1, date2)).toLocaleDateString('en-us', {
// 			year: 'numeric',
// 			month: 'long',
// 			day: 'numeric',
// 		});
...
// const randomShipDate = (date, delay) => {
...
// 	const shippedDate = new Date(orderDate.getTime() + day * delayDay).toLocaleDateString('en-us', {
// 		year: 'numeric',
// 		month: 'long',
// 		day: 'numeric',
// 	});
...
// if (s.length % 2 !== 0 || !bracketPairs.has(s[0]) || bracketPairs.has(s[s.length - 1])) {
// 	return false;
// }

const timers = [0, 2, 10, 5, 12, 22, 15, 0];

const findIndex = (elapsedTime) => {
	let remainingTime = elapsedTime;
	let index = 0;

	while (remainingTime > timers[index]) {
